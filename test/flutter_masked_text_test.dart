...
void main() {
  group('masked text', () {
    test('12345678901 with mask 000.000.000-00 results 123.456.789-01', () {
      final cpfController = MaskedTextController(text: '12345678901', mask: '000.000.000-00');
    ...
    test('remove * translator must keep * in the mask', () {
      ...
      final controller = MaskedTextController(mask: '0000 **** **** 0000', translator: translator);
